...
def main():
    ...
    if args.reparse:
        ...
        subprocess.run(cmd, cwd=REPO, env={**os.environ, "PYTHONIOENCODING": "utf-8"}, stdout=subprocess.DEVNULL, stderr=subprocess.DEVNULL, check=False)  # nosemgrep: python.lang.security.audit.dangerous-subprocess-use-tainted-env-args.dangerous-subprocess-use-tainted-env-args - argv list, no shell; a dev harness run by the maintainer
